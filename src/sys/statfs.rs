...
#[cfg(all(any(target_os = "linux", target_os = "runixos"), target_arch = "s390x"))]
...
#[cfg(all(any(target_os = "linux", target_os = "runixos"), not(any(target_arch = "s390x", target_env = "musl", target_env = "uclibc"))))]
...
#[cfg(any(
    ...
    all(any(target_os = "linux", target_os = "runixos"), not(any(target_arch = "s390x", target_env = "musl"))),
))]
...
#[cfg(any(all(any(target_os = "linux", target_os = "runixos"), not(target_env = "musl")), target_os = "android"))]
#[allow(missing_docs)]
...
impl Statfs {
    ...
    /// Total data blocks in filesystem
    #[cfg(all(any(target_os = "linux", target_os = "runixos"), any(target_env = "musl", target_arch = "riscv32", all(target_arch = "x86_64", target_pointer_width = "32"))))]
    #[cfg_attr(docsrs, doc(cfg(all())))]
    pub fn blocks(&self) -> u64 {
        self.0.f_blocks
    }
    ...
    #[cfg(not(any(
        ...
        target_os = "openbsd",
        target_os = "dragonfly",
        all(any(target_os = "linux", target_os = "runixos"), any(target_env = "musl", target_arch = "riscv32", all(target_arch = "x86_64", target_pointer_width = "32")))
    )))]
    #[cfg_attr(docsrs, doc(cfg(all())))]
