...
libc_bitflags! {
    ...
    pub struct MapFlags: c_int {
        ...
        #[cfg(any(all(linux_android,
                  ...
                  all(any(target_os = "linux", target_os = "runixos"), target_env = "ohos", target_arch = "x86_64"),
        ...
        #[cfg(all(any(target_os = "linux", target_os = "runixos"), not(any(target_arch = "mips", target_arch = "mips64", target_arch = "mips32r6", target_arch = "mips64r6")), not(target_env = "uclibc")))]
        MAP_SYNC;
...
#[cfg(any(any(target_os = "linux", target_os = "runixos"), target_os = "netbsd"))]
libc_bitflags! {
    /// Options for [`mremap`].
